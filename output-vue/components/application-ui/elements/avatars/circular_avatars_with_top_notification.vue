<template>
  ...
  <span class="inline-block relative">
    ...
    <span class="absolute top-0 right-0 block h-3 w-3 rounded-full text-white shadow-solid bg-gray-300"></span>
  </span>
  ...
  <span class="inline-block relative">
    ...
    <span class="absolute top-0 right-0 block h-3.5 w-3.5 rounded-full text-white shadow-solid bg-red-400"></span>
  </span>
  ...
  <span class="inline-block relative">
    ...
    <span class="absolute top-0 right-0 block h-4 w-4 rounded-full text-white shadow-solid bg-green-400"></span>
  </span>
</template>
