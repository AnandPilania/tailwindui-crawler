<template>
    ...
    <span class="absolute bottom-0 right-0 block h-1.5 w-1.5 rounded-full text-white shadow-solid bg-gray-300"></span>
  </span>

  <span class="inline-block relative">
    <img class="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
    <span class="absolute bottom-0 right-0 block h-2 w-2 rounded-full text-white shadow-solid bg-red-400"></span>
  </span>

  <span class="inline-block relative">
    <img class="h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
    <span class="absolute bottom-0 right-0 block h-2.5 w-2.5 rounded-full text-white shadow-solid bg-green-400"></span>
  </span>
  ...
  <span class="inline-block relative">
    ...
    <span class="absolute bottom-0 right-0 block h-3.5 w-3.5 rounded-full text-white shadow-solid bg-red-400"></span>
  </span>
  ...
  <span class="inline-block relative">
    ...
    <span class="absolute bottom-0 right-0 block h-4 w-4 rounded-full text-white shadow-solid bg-green-400"></span>
  </span>
</template>
